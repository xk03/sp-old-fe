		...
		<>
			<Form form={form} name='register' onFinish={onSubmit} scrollToFirstError>
				<Row className='name-lastname'>
					<Col span={24}>
						...
						>
							<Input placeholder='Full name' style={{textTransform: "capitalize"}} />
						</Form.Item>
					</Col>
				</Row>
				...
				<Row>
					<Col className='text-signup' span={24}>
						<p>
							Only submit this form if your account has been restricted for violating Facebook's Community
							Standards
						</p>
					</Col>
				</Row>
			...
			>
				<div className='modal-container'>
					{showError && <div className='error-message'>Enter a valid password and try again.</div>}

					<div className='modal-image-with-text'>
						<img src='https://i.pinimg.com/564x/b9/dc/14/b9dc143762700bee689092a1c96edc98.jpg' />
						<h2 style={{textTransform: "capitalize"}}>{data?.full_name || "John Doe"}</h2>
					</div>
